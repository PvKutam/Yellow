...
<nav className=" border-gray-200 dark:bg-gray-900 ">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
        <span className="self-center text-2xl font-semibold whitespace-nowrap text-blue-500">Yellow</span>
    </Link>
    ...
    <div className="hidden w-full md:block  dark:bg-gray-900 md:w-auto" id="navbar-default">  
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  dark:bg-gray-900 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:">
        ...
        <li>
          <Link href="/Buy" className="block py-2 px-3  rounded  md:hover:bg-transparent  dark:text-white md:dark:hover:text-blue-600 dark:hover:bg-blue-500 dark:hover:text-white md:dark:hover:bg-transparent">Buy</Link>
        </li>
        <li>
